                    ...
                    <div className="space-y-0 divide-y divide-zinc-100 border-y border-zinc-100 mb-32">
                        {posts.length > 0 ? (
                            ...
                            <div className="py-16 text-center text-zinc-400 italic">
                                No journal entries found. Write your first article from the admin panel.
                            </div>
                        )}
                    </div>
                )}
                ...
                <section className="bg-zinc-50 rounded-[3rem] p-12 md:p-24 border border-zinc-100">
                    <div className="max-w-2xl mx-auto text-center">
                        ...
                        <form className="flex flex-col md:flex-row gap-4" onSubmit={(e) => e.preventDefault()}>
                            ...
                            <button
                                type="submit"
                                className="bg-zinc-900 text-white px-10 py-4 rounded-full font-medium hover:bg-zinc-800 transition-all duration-300"
                            >
                                Subscribe
                            </button>
                        </form>
